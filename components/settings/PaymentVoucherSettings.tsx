    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md w-full">
            ...
            <div className="mb-6 pb-4 border-b">
                <h2 className="text-xl font-bold text-gray-800">إعدادات سندات الصرف</h2>
                <p className="text-sm text-gray-500 mt-1">تخصيص شكل ومحتوى سندات الصرف الخاصة بك.</p>
            </div>
            <form className="space-y-6">
                ...
                >
                    <ImageUploader label="صورة الهيدر" currentImage="https://picsum.photos/seed/payheader/800/150" />
                </SettingsSection>
                ...
                >
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <ConfigurableField label="صرف إلى" defaultLabel="صرف إلى السيد/السادة" isEnabled={true} />
                ...
                >
                    <div>
                     ...
                     <ImageUploader label="صورة الفوتر" currentImage="https://picsum.photos/seed/payfooter/800/100" />
                </SettingsSection>
