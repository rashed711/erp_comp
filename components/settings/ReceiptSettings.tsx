...
import { getReceiptSettings } from '../../services/mockApi';
        ...
        <div className="bg-white p-6 rounded-lg shadow-md w-full">
            ...
            <form className="space-y-6">
                ...
                >
                    ...
                    <ImageUploader label={t('settings.doc.headerImage')} currentImageUrl="https://picsum.photos/seed/recheader/800/150" />
                </SettingsCard>
                ...
                >
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <ConfigurableField fieldKey="customerInfo" label={t('settings.doc.field.receivedFrom')} currentLabel={t('settings.doc.field.receivedFrom')} isEnabled={true} />
                        <ConfigurableField fieldKey="receiptNumber" label={t('settings.doc.field.receiptNumber')} currentLabel={t('settings.doc.field.receiptNumber')} isEnabled={true} />
                ...
                >
                    <div>
                     ...
                     {/* FIX: Corrected prop name from 'currentImage' to 'currentImageUrl'. */}
                     <ImageUploader label={t('settings.doc.footerImage')} currentImageUrl="https://picsum.photos/seed/recfooter/800/100" />
                </SettingsCard>
