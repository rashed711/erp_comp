    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md w-full">
            ...
            <div className="mb-6 pb-4 border-b">
                <h2 className="text-xl font-bold text-gray-800">إعدادات سندات القبض</h2>
                <p className="text-sm text-gray-500 mt-1">تخصيص شكل ومحتوى سندات القبض الخاصة بك.</p>
            </div>
            <form className="space-y-6">
                ...
                >
                    <ImageUploader label="صورة الهيدر" currentImage="https://picsum.photos/seed/recheader/800/150" />
                </SettingsSection>

                <SettingsSection
                    title="2. تخصيص بيانات السند"
                    description="تحكم في الحقول التي تظهر في السند. يمكنك تعديل المسمى أو إخفاء الحقل."
                >
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <ConfigurableField label="استلمنا من" defaultLabel="استلمنا من السيد/السادة" isEnabled={true} />
                        <ConfigurableField label="رقم السند" defaultLabel="رقم السند" isEnabled={true} />
                        <ConfigurableField label="التاريخ" defaultLabel="التاريخ" isEnabled={true} />
                        <ConfigurableField label="طريقة الدفع" defaultLabel="طريقة الدفع" isEnabled={true} />
                        <ConfigurableField label="المبلغ" defaultLabel="مبلغاً وقدره" isEnabled={true} />
                        <ConfigurableField label="الوصف" defaultLabel="وذلك عن" isEnabled={true} />
                    </div>
                </SettingsSection>
                
                <SettingsSection
                    title="3. تخصيص تذييل الصفحة (Footer)"
                    description="أضف الملاحظات الافتراضية وصورة الفوتر (مثل: بيانات التواصل أو التواقيع)."
                >
                    <div>
                     ...
                     <ImageUploader label="صورة الفوتر" currentImage="https://picsum.photos/seed/recfooter/800/100" />
                </SettingsSection>
