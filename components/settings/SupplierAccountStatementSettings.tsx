...
const SupplierAccountStatementSettings: React.FC = () => {
    ...
    useEffect(() => {
        const fetchSettings = async () => {
            ...
            setError(null);
            try {
                const response = await fetch(`${API_BASE_URL}settings.php?scope=supplierStatement`, { cache: 'no-cache' });
                if (!response.ok) {
                    throw new Error(t('settings.doc.titleSupplierStatements') + ': ' + t('common.error'));
                }
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}settings.php?scope=supplierStatement`, {
                method: 'POST',
                body: formData,
            });
            ...
            const updatedSettingsRes = await fetch(`${API_BASE_URL}settings.php?scope=supplierStatement`);
