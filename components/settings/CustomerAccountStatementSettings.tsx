        ...
        <div className="bg-white p-6 rounded-lg shadow-md w-full">
            ...
            <form className="space-y-6">
                ...
                >
                    ...
                    <ImageUploader label={t('settings.doc.headerImage')} currentImageUrl="https://picsum.photos/seed/custstmt-header/800/150" />
                </SettingsCard>
                ...
                >
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <ConfigurableField fieldKey="contactInfo" label={t('settings.doc.field.customerData')} currentLabel={t('settings.doc.field.customerData')} isEnabled={true} />
                        ...
                        <ConfigurableField fieldKey="totalDebit" label={t('settings.doc.field.totalDebit')} currentLabel={t('settings.doc.field.totalDebit')} isEnabled={true} />
                ...
                >
                    <div>
                     ...
                     {/* FIX: Corrected prop name from 'currentImage' to 'currentImageUrl'. */}
                     <ImageUploader label={t('settings.doc.footerImage')} currentImageUrl="https://picsum.photos/seed/custstmt-footer/800/100" />
                </SettingsCard>
