    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md w-full">
            ...
            <div className="mb-6 pb-4 border-b">
                <h2 className="text-xl font-bold text-gray-800">إعدادات كشوف حساب العملاء</h2>
                <p className="text-sm text-gray-500 mt-1">تخصيص شكل ومحتوى كشوفات حساب العملاء.</p>
            </div>
            <form className="space-y-6">
                ...
                >
                    <ImageUploader label="صورة الهيدر" currentImage="https://picsum.photos/seed/custstmt-header/800/150" />
                </SettingsSection>
                ...
                >
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <ConfigurableField label="بيانات العميل" defaultLabel="بيانات العميل" isEnabled={true} />
                        ...
                        <ConfigurableField label="إجمالي المستحقات (مدين)" defaultLabel="إجمالي المستحقات (مدين)" isEnabled={true} />
                ...
                >
                    <div>
                     ...
                     <ImageUploader label="صورة الفوتر" currentImage="https://picsum.photos/seed/custstmt-footer/800/100" />
                </SettingsSection>
