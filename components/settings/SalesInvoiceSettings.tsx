    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md w-full">
            ...
            <form className="space-y-6">
                ...
                >
                    <ImageUploader label={t('settings.doc.headerImage')} currentImage="https://picsum.photos/seed/invheader/800/150" />
                </SettingsCard>
                ...
                >
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <ConfigurableField label={t('settings.doc.field.invoiceTo')} defaultLabel={t('settings.doc.field.invoiceTo')} isEnabled={true} />
                        <ConfigurableField label={t('settings.doc.field.invoiceNumber')} defaultLabel={t('settings.doc.field.invoiceNumber')} isEnabled={true} />
