    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md w-full">
            ...
            <div className="mb-6 pb-4 border-b">
                <h2 className="text-xl font-bold text-gray-800">إعدادات فواتير المبيعات</h2>
                <p className="text-sm text-gray-500 mt-1">تخصيص شكل ومحتوى فواتير المبيعات الخاصة بك.</p>
            </div>
            <form className="space-y-6">
                ...
                >
                    <ImageUploader label="صورة الهيدر" currentImage="https://picsum.photos/seed/invheader/800/150" />
                </SettingsSection>
                ...
                >
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <ConfigurableField label="فاتورة إلى" defaultLabel="فاتورة إلى" isEnabled={true} />
                        <ConfigurableField label="رقم الفاتورة" defaultLabel="رقم الفاتورة" isEnabled={true} />
                ...
                >
                    <div>
                     ...
                     <ImageUploader label="صورة الفوتر" currentImage="https://picsum.photos/seed/invfooter/800/100" />
                </SettingsSection>
