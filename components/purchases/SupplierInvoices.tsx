    ...
    return (
        <>
            <div className="space-y-8">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">فواتير المشتريات</h1>
                    <p className="text-gray-500">إدارة وإنشاء فواتير المشتريات الخاصة بك.</p>
                </div>
                ...
                <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md w-full">
                    <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
                        <h2 className="text-xl font-semibold text-gray-800 w-full sm:w-auto">قائمة فواتير المشتريات</h2>
                        <div className="flex items-center gap-4 w-full sm:w-auto">
                            ...
                            <button 
                                ...
                                <span className="hidden sm:inline mr-2">إضافة فاتورة جديدة</span>
                            </button>
                        </div>
                    </div>
