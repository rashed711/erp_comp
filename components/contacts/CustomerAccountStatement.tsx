...
import { getCustomerAccountStatement, getCustomerAccountStatementSettings, getCompanySettings } from '../../services/mockApi';
...
const CustomerAccountStatement: React.FC<CustomerAccountStatementProps> = ({ customerId, onBack }) => {
    ...
    useEffect(() => {
        const fetchStatement = () => {
            const data = getCustomerAccountStatement(customerId);
    ...
    const handleDownloadPdf = async () => {
        ...
        if (input) {
            ...
            try {
                ...
                pdf.save(`Customer-Statement-${statement?.contactId}.pdf`);
            } catch (error) {
    ...
    const renderSummary = () => {
        ...
        const summaryItems = [
            ...
            { key: 'totalDebit', label: 'إجمالي المستحقات (مدين)', value: totalDebit, color: 'red' },
            ...
            <header className="bg-white shadow-sm p-4 sticky top-0 z-30 no-print">
                <div className="container mx-auto flex justify-between items-center flex-wrap gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                             <h1 className="text-lg sm:text-xl font-bold text-emerald-600">كشف حساب عميل</h1>
