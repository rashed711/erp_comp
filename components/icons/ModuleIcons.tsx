...
// Existing Icons (some cleaned up or replaced)
...
export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.664M7.5 10.5a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0z" /></svg>
);
export const UserGroupIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.513-.96 1.487-1.574 2.57-1.574 1.282 0 2.44.874 2.57 1.574m-3.292 2.962l3.292 2.962m-7.5-2.962c.513-.96 1.487-1.574 2.57-1.574 1.282 0 2.44.874 2.57 1.574m-3.292 2.962l3.292 2.962M9 10.5a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zm7.5-1.5a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zm-3.75 6.75a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z" /></svg>
);
...
export const CogIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5M12 4.5v.01M12 21v-.01M4.5 12h.01M21 12h-.01M6.337 6.337h.01M19.5 19.5h-.01M6.337 19.5h.01M19.5 6.337h-.01" /></svg>
);
...
export const ShareIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.042.586.042.21 0 .424-.015.63-.042m-1.215 2.186a2.25 2.25 0 00-.63-.042 2.25 2.25 0 00-1.737 1.039 4.873 4.873 0 00.163 5.427c.11.144.239.27.38.381a2.25 2.25 0 003.263 0 4.873 4.873 0 00.163-5.427 2.25 2.25 0 00-1.737-1.039 2.25 2.25 0 00-.63.042zM16.5 9.75a2.25 2.25 0 100 2.186c.195.025.39.042.586.042.21 0 .424-.015.63-.042a2.25 2.25 0 001.737-1.039 4.873 4.873 0 00-.163-5.427c-.11-.144-.239-.27-.38-.381a2.25 2.25 0 00-3.263 0 4.873 4.873 0 00-.163 5.427 2.25 2.25 0 001.737 1.039m-9.342 3.427a2.25 2.25 0 000-2.186m0 2.186c-.195-.025-.39-.042-.586-.042-.21 0-.424.015-.63.042a2.25 2.25 0 00-1.737 1.039 4.873 4.873 0 00.163 5.427c.11.144.239.27.38.381a2.25 2.25 0 003.263 0 4.873 4.873 0 00.163-5.427 2.25 2.25 0 00-1.737-1.039 2.25 2.25 0 00-.63.042z" /></svg>
);
